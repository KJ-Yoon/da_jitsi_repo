...
export default class SmallVideo {
    ...
    constructor(VideoLayout) {
        ...
        /**
         * Whether or not the da recording indicator should be displayed.
         *
         * @private
         * @type {boolean}
         */
        this._showDaRecording = false;
    ...
    */
    ...
    showDaRecordingIndicator(show) {
        if (!this.container) {
            logger.warn(`Unable to da recording indication - ${
                this.videoSpanId} does not exist`);

            return;
        }

        this._showDaRecording = show;
        this.updateIndicators();
    }
