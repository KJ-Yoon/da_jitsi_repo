...
MiddlewareRegistry.register(store => next => action => {
    ...
    case SET_REDUCED_UI: {
        ...
        const { reducedUI } = state['features/base/responsive-ui']; //reducedUI : false 에 false값 넣음
        //console.log(state['features/base/responsive-ui'], "here"); 
        //console.log(reducedUI, "here2"); // false
