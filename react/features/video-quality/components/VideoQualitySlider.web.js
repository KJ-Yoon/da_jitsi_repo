...
class VideoQualitySlider extends Component<Props> {
     ...
     */
    constructor(props) {
        //alert("VideoQualitySlider.web.js - constructor");
        super(props);
    ...
    componentDidMount() {
        //alert("VideoQualitySlider.web.js - componentDidMount");
    }
    /**
    ...
    _enableLowDefinition() {
        //alert("low");
        sendAnalytics(createEvent('low')); //실제로 이거 없어도 된다.(추측)
    ...
    _onSliderChange(event) {
        ...
        //alert("VideoQualitySlider.web.js - _onSliderChange");
        const { _audioOnly, _sendrecvVideoQuality } = this.props;
        
        // console.log(event.target.value); // slider 배열번호
        // console.log(this._sliderOptions[event.target.value]);
    ...
    _setPreferredVideoQuality(qualityLevel) {
        //alert("VideoQualitySlider.web.js - _setPreferredVideoQuality");
