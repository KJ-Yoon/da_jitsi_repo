...
class StatelessDialog extends Component<Props> {
    ...
    _onSubmit(value) {
        ...
        if(this.props.titleKey == "settings.title"){
            if(this.props.children.props.children.props.tabs[1].content.props.children.props.displayName == "" || this.props.children.props.children.props.tabs[1].content.props.children.props.displayName == undefined){
